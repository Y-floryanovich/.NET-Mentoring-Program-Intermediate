...
namespace Expressions.Task3.E3SQueryProvider.Test
{
    public class E3SAndOperatorSupportTests
    {
        ...
        {
            FtsRequestGenerator ftsRequestGenerator = new FtsRequestGenerator("http://www.myserver.com");
            ...
            var serialized = ftsRequestGenerator.GetFtsQueryRequest(translated);
            Assert.Equal("{\"statements\":[{\"query\":\"Workstation:(EPRUIZHW006)\"},{\"query\":\"Manager:(John*)\"}],\"filters\":[],\"sorting\":{},\"start\":0,\"limit\":10}", serialized);
        }
